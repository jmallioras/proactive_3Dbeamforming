...
num_layers = 1
lr = 0.0001
model_path = pwd+'/lstm_mtm_checkpoint3.pth'
plotname = 'lstm_mtm_training_prog3.png'

# Initialize the model
model = DoAModel(input_dim=input_dim, hidden_dim=hidden_dim, output_dim=2, num_layers=num_layers, max_sequence_length=5).to(device)
